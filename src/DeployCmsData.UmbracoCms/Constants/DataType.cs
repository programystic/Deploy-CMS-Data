...
// SELECT       'public static Guid ' + REPLACE(REPLACE(REPLACE(text, ' ', ''), '-', ''), '/', '') +  ' { get; } = new Guid("' + convert(nvarchar(50), uniqueId) + '");'
// FROM         CmsDataType
...
namespace DeployCmsData.UmbracoCms.Constants
{
    public static class DataType
    {
        ...
        public static Guid Numeric { get; } = new Guid("2E6D3631-066E-44B8-AEC4-96F09099B2B5");
        ...
        public static Guid ContentPicker { get; } = new Guid("A6857C73-D6E9-480C-B6E6-F15F6AD11125");
        public static Guid MediaPicker { get; } = new Guid("93929B9A-93A2-4E2A-B239-D99334440A59");
        public static Guid MemberPicker { get; } = new Guid("2B24165F-9782-4AA3-B459-1DE4A4D21F60");
        public static Guid RelatedLinks { get; } = new Guid("21E798DA-E06E-4EDA-A511-ED257F78D4FA");
        ...
        public static Guid MultipleMediaPicker { get; } = new Guid("7E3962CC-CE20-4FFC-B661-5897A894BA7E");
        public static Guid MultiNodeTreePicker { get; } = new Guid("60FFCA99-3B98-49EA-9F64-E4C69BB00285");
        public static Guid DefaultGridView { get; } = new Guid("3D7B34BF-1E2E-4D49-A040-1C25D14E2074");
    }
}