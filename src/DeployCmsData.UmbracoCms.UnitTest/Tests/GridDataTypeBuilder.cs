...
namespace DeployCmsData.UmbracoCms.UnitTest.Tests
{
    ...
    public static class GridDataTypeBuilder
    {
        ...
        public static void DefaultGridView()
        {
            ...
            Assert.IsInstanceOf<IDataType>(gridDataType);
            Assert.AreEqual("My New Grid View", gridDataType.Name);
            Assert.AreEqual(PropertyEditors.Aliases.Grid, gridDataType.EditorAlias);
        ...
        [Test]
        public static void ModeClassic()
        {
            var builder = new GridDataTypeTestBuilder(Guid.NewGuid())
                .Build();

            builder
                .Mode(Enums.GridMode.Classic)
                .Build();
        ...
        [Test]
        public static void ModeDistractionFree()
        {
            var builder = new GridDataTypeTestBuilder(Guid.NewGuid())
                .Build();

            builder
                .Mode(Enums.GridMode.DistractionFree)
                .Build();

            Assert.AreEqual("distraction-free", builder.GridRtePreValue.Mode);

        }

        [Test]
        public static void ModeDefaultsToClassic()
        {
            var builder = new GridDataTypeTestBuilder(Guid.NewGuid())
                .Build();
