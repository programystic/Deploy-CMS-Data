...
namespace DeployCmsData.UmbracoCms.UnitTest.Tests
{
    internal class UpdateProperties
    {
        ...
        public static void ChangeDataType()
        {
            ...
            Assert.AreEqual(2, setup.UmbracoFactory.Object.GetPropertyType(docType, "field1").DataTypeId);
            Assert.AreEqual(0, setup.UmbracoFactory.Object.GetPropertyType(docType, "field2").DataTypeId);
            Assert.AreEqual(0, setup.UmbracoFactory.Object.GetPropertyType(docType, "field3").DataTypeId);
            Assert.AreEqual(3, setup.UmbracoFactory.Object.GetPropertyType(docType, "field4").DataTypeId);
        }
    }
}