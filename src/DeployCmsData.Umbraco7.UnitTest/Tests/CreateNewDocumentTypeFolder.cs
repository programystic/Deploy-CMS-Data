...
namespace DeployCmsData.Umbraco7.UnitTest.Tests
{
    ...
    public static class CreateNewDocumentTypeFolder
    {
        ...
        public static void CreateFolderAtRoot()
        {
            ...
            setup.UmbracoFactory.Verify(x => x.NewContainer(Umbraco7.Constants.Umbraco.RootFolder, folderName, 1), Times.Once);
        ...
        public static void CreateFolderWithParentFolderAndLevel()
        {
            ...
            Umbraco7.Builders.DocumentTypeFolderBuilder builder = setup
                .ReturnsNewFolder(folderName)
        ...
        public static void DocumentTypeFolderCreateWithInvalidParentNoLevel()
        {
            ...
            setup.UmbracoFactory.Verify(x =>
                    x.GetContainer(
                        parentFolderName,
                        It.IsAny<int>()),
                Times.Exactly(Constants.Umbraco.MaximumFolderLevel));
        }
    }
}